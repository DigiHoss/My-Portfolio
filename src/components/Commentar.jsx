    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
                ...
                className="relative w-full h-12 primary_gradient rounded-xl font-medium font-Poppins text-white overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed"
            >
...
const Komentar = () => {
    ...
    useEffect(() => {
        ...
        const commentSubscription = supabase
            .channel('portfolio-comments-channel')
            .on('postgres_changes', { 
                event: '*', 
                schema: 'public', 
                table: 'portfolio-comments' 
            }, () => {
                fetchComments();
            })
            .subscribe();
    ...
    const uploadImage = useCallback(async (imageFile) => {
        ...
        const filePath = `profile-images/${Date.now()}_${imageFile.name}`;
        ...
        try {
            ...
            const { error: insertError } = await supabase
                ...
                .insert([{
                    ...
                    // Note: created_at will be handled by Supabase's default timestamp
                }]);
