...
const ToggleButton = ({ onClick, isShowingMore }) => (
  ...
  >
    ...
    <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#2CCFFF] transition-all duration-300 group-hover:w-full"></span>
  </button>
);
...
const techStacks = [
  ...
  { icon: "angular.svg", language: "AngularJS" },
  ...
  { icon: "c-plus-plus.svg", language: "C++" },
...
export default function FullWidthTabs() {
  ...
  const displayedTechStacks = showAllTechStacks
    ? techStacks
    : techStacks.slice(0, initialTechItems);
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-gradient-color font-Poppins">
          <span>Portfolio Showcase</span>
        </h2>
        <p className="text-white font-Montserrat max-w-2xl mx-auto text-sm md:text-base mt-2">
          ...
          <TabPanel value={value} index={0} dir={theme.direction}>
            <div className="container mx-auto flex justify-center items-center overflow-hidden">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-3 gap-5">
                <div className="text-Montserrat text-white flex md:justify-center">Projects will be added soon !</div>
                {displayedProjects.map((project, index) => (
                  ...
                  >
                    <CardProject
                      ...
                      TechStacks={project.project_techstacks}
